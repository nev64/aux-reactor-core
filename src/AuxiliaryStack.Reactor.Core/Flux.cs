...
namespace AuxiliaryStack.Reactor.Core
{
    ...
    public static class Flux
    {
        ...
        {
            return CombineLatest(a => combiner((T1)a[0], (T2)a[1]), 
        ...
        /// <returns>The new IFlux instance.</returns>
        public static IFlux<long> Interval(TimeSpan period, ITimedScheduler scheduler)
        {
        ...
        /// <param name="scheduler">The scheduler to use for emitting each number.</param>
        /// <returns>The new IFlux instance.</returns>
        public static IFlux<long> Interval(TimeSpan initialDelay, TimeSpan period, ITimedScheduler scheduler)
        {
        ...
        /// <returns>The new IFlux instance.</returns>
        public static IFlux<long> Timer(TimeSpan delay, ITimedScheduler scheduler)
        {
        ...
        /// <returns>The new IFlux instance.</returns>
        public static IFlux<IList<T>> Buffer<T>(this IFlux<T> source, TimeSpan timespan, ITimedScheduler scheduler)
        {
        ...
        /// <returns>The new IFlux instance.</returns>
        public static IFlux<IList<T>> Buffer<T>(this IFlux<T> source, TimeSpan timespan, TimeSpan timeskip, ITimedScheduler scheduler)
        {
        ...
        /// <param name="scheduler">The timed scheduler to provide the timing of sub-buffer boundaries.</param>
        /// <returns>The new IFlux instance.</returns>
        public static IFlux<IList<T>> Buffer<T>(this IFlux<T> source, int maxSize, TimeSpan timespan, ITimedScheduler scheduler)
        {
        ...
        /// <returns>The new IFlux instance.</returns>
        public static IFlux<T> Delay<T>(this IFlux<T> source, TimeSpan delay, ITimedScheduler scheduler)
        {
        ...
        /// <param name="scheduler">The timed scheduler to use for the time shifting.</param>
        /// <returns>The new IFlux instance</returns>
        public static IFlux<T> DelaySubscription<T>(this IFlux<T> source, TimeSpan delay, ITimedScheduler scheduler)
        {
        ...
        /// <returns>The new IFlux instance.</returns>
        public static IFlux<Timed<T>> Elapsed<T>(this IFlux<T> source, ITimedScheduler scheduler)
        {
        ...
        /// <returns>The new IFlux instance.</returns>
        public static IFlux<T> PublishOn<T>(this IFlux<T> source, IScheduler scheduler, bool delayError = true)
        {
        ...
        /// <param name="delayError">If true, OnError signals won't skip ahead of the OnNext signals.</param>
        /// <returns>The new IFlux instance.</returns>
        public static IFlux<T> PublishOn<T>(this IFlux<T> source, IScheduler scheduler, int prefetch, bool delayError = true)
        {
        ...
        /// <returns>The new IFlux instance.</returns>
        public static IFlux<T> Sample<T>(this IFlux<T> source, TimeSpan timespan, ITimedScheduler scheduler)
        {
        ...
        /// emission of the sampled value.</param>
        /// <returns>The new IFlux instance.</returns>
        public static IFlux<T> SampleFirst<T>(this IFlux<T> source, TimeSpan timespan, ITimedScheduler scheduler)
        {
        ...
        /// emission of the sampled value.</param>
        /// <returns>THe new IFlux instance.</returns>
        public static IFlux<T> SampleTimeout<T>(this IFlux<T> source, TimeSpan timespan, ITimedScheduler scheduler)
        {
        ...
        /// <returns>The new IFlux instance.</returns>
        public static IFlux<T> Skip<T>(this IFlux<T> source, TimeSpan timespan, ITimedScheduler scheduler)
        {
        ...
        /// <returns>The new IFlux isntance.</returns>
        public static IFlux<T> SubscribeOn<T>(this IFlux<T> source, IScheduler scheduler)
        {
        ...
        /// <returns>The new IFlux instance.</returns>
        public static IFlux<T> Take<T>(this IFlux<T> source, TimeSpan timespan, ITimedScheduler scheduler)
        {
        ...
        /// <returns>The new IFlux instance.</returns>
        public static IFlux<T> Timeout<T>(this IFlux<T> source, TimeSpan timeout, ITimedScheduler scheduler, IPublisher<T> fallback = null)
        {
        ...
        /// <returns>The new IFlux instance.</returns>
        public static IFlux<Timed<T>> Timestamp<T>(this IFlux<T> source, ITimedScheduler scheduler)
        {
        ...
        /// <returns>a windowing IFlux of timed IFlux buckets</returns>
        public static IFlux<IFlux<T>> Window<T>(this IFlux<T> source, TimeSpan timespan, ITimedScheduler scheduler)
        {
        ...
        /// <returns>a windowing IFlux of IFlux buckets delimited by an opening IPublisher and a selected closing IPublisher</returns>
        public static IFlux<IFlux<T>> Window<T>(this IFlux<T> source, TimeSpan timespan, TimeSpan timeskip, ITimedScheduler scheduler)
        {
            // TODO implement Window
            throw new NotImplementedException();
        }
        ...
        /// <param name="scheduler">The timed scheduler to run the timed support operations.</param>
        /// <returns>a windowing IFlux of sized or timed IFlux buckets</returns>
        public static IFlux<IFlux<T>> Window<T>(this IFlux<T> source, int maxSize, TimeSpan timespan, ITimedScheduler scheduler)
        {
            // TODO implement Window
            throw new NotImplementedException();
        }
