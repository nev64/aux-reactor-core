...
namespace AuxiliaryStack.Reactor.Core
{
    ...
    public static class Mono
    {
        ...
        /// <returns>A new IMono instance.</returns>
        public static IMono<long> Delay(TimeSpan delay, ITimedScheduler scheduler)
        {
        ...
        /// <returns>The new IMono instance.</returns>
        public static IMono<T> DelaySubscription<T>(this IMono<T> source, TimeSpan delay, ITimedScheduler scheduler)
        {
        ...
        /// <returns>The new IMono instance.</returns>
        public static IMono<Timed<T>> Elapsed<T>(this IMono<T> source, ITimedScheduler scheduler)
        {
        ...
        /// <returns>The new IMono instance.</returns>
        public static IMono<T> PublishOn<T>(this IMono<T> source, IScheduler scheduler)
        {
        ...
        /// <returns>The new IMono instance.</returns>
        public static IMono<T> SubscribeOn<T>(this IMono<T> source, IScheduler scheduler)
        {
        ...
        /// this IMono instance.</param>
        /// <returns>The new IMono instance.</returns>
        public static IMono<T> Timeout<T>(this IMono<T> source, TimeSpan timeout, ITimedScheduler scheduler, IMono<T> fallback = null)
        {
        ...
        /// time.</param>
        /// <returns>The new IMono instance.</returns>
        public static IMono<Timed<T>> Timestamp<T>(this IMono<T> source, ITimedScheduler scheduler)
        {
